    ...
    if (Menu == 1) {
      ...
      if (Temperatura >= 30 && BuzzerOn) {
       ...
       if (Temperatura >= 30) tft.setTextColor(TFT_RED, TFT_BLACK);
        ...
        tft.drawFloat(Temperatura, 2, 240, 80, 1);  //Valoare, cifre dupa virgula, x, y, marime font
        ...
        tft.drawFloat(Umiditate, 2, 240, 120, 1);  //Valoare, cifre dupa virgula, x, y, marime font
        tft.drawString("%", 320, 125, 4);
        tft.setTextColor(TFT_WHITE, TFT_BLACK);


        tft.drawString("Presiune", 10, 160, 4);   //Text, x, y, marime font
        tft.drawFloat(Presiune, 2, 240, 160, 1);  //Valoare, cifre dupa virgula, x, y, marime font
        tft.drawString("hPa", 340, 165, 4);

        tft.drawString("Concentratie Gaz", 10, 200, 4);  //Text, x, y, marime font
        tft.drawFloat(ConcentratieGaz, 0, 240, 200, 1);  //Valoare, cifre dupa virgula, x, y, marime font
