  ...
  if (millis() - TimpAnteriorSec >= RefreshSecunda || ActualizareMeniu) { //Bucla se ruleaza o data pe secunda sau daca rularea este impusa fortata de ActualizareMeniu
    ...
    if (Menu == 1) {                                                      //Cand meniul 1"HOME" este selectat
      ...
      if (SursaSelectata == 1) {
        ...
        tft.drawFloat(VOCvalue, 2, 240, 200, 4);
...
/*
      ...
      if (SursaSelectata == 2) {
        ...
        tft.fillRect(200, 80, 80, 20, TFT_BLACK);
        tft.drawFloat(ETemp, 2, 240, 80, 4);

        tft.drawFloat(EUmid, 2, 240, 120, 4);

        tft.fillRect(190, 160, 100, 20, TFT_BLACK);
        tft.drawFloat(EPres, 2, 240, 160, 4);
    ...
    if (Menu == 2) {                                                  //Cand meniul 2"MINIM" este selectat
      ...
      if (SursaSelectata == 2) {
        ...
        tft.fillRect(240, 80, 80, 20, TFT_BLACK);
        tft.drawFloat(ETempMin, 2, 240, 80, 4);

        tft.drawFloat(EUmidMin, 2, 240, 120, 4);

        tft.fillRect(240, 160, 100, 20, TFT_BLACK);
        tft.drawFloat(EPresMin, 2, 240, 160, 4);
    ...
    if (Menu == 3) {                                                  //Cand meniul 3"MAXIM" este selectat
      ...
      if (SursaSelectata == 2) {
        ...
        tft.fillRect(240, 80, 80, 20, TFT_BLACK);
        tft.drawFloat(ETempMax, 2, 240, 80, 4);

        tft.drawFloat(EUmidMax, 2, 240, 120, 4);

        tft.fillRect(240, 160, 100, 20, TFT_BLACK);
        tft.drawFloat(EPresMax, 2, 240, 160, 4);
...
void Meniu1() {                                      //In meniul 1 "HOME"↓
  ...
  //tft.pushImage(440, 40, 32, 21, MenuIcon);          //Buton "Alege sursa"
...
void Meniu2() {                                      //In meniul 2 "MINIME"↓
  ...
  //Se afiseaza  textul static, deoarece nu se mai actualizeaza cresc performanta//
  tft.drawString("TMin", 10, 80, 4);
  tft.drawString("*C", 360, 80, 4);
  tft.drawString("UMin", 10, 120, 4);
  tft.drawString("%", 360, 120, 4);
  tft.drawString("PMin", 10, 160, 4);
  if (BmeUM == 1)tft.drawString("hPa", 360, 160, 4);
  if (BmeUM == 2)tft.drawString("mmHg", 360, 160, 4);
...
void Meniu3() {                                      //In meniul 2 "MAXIME"↓
  ...
  //Se afiseaza  textul static, deoarece nu se mai actualizeaza cresc performanta//
  tft.drawString("TMax", 10, 80, 4);
  tft.drawString("*C", 360, 80, 4);
  tft.drawString("UMax", 10, 120, 4);
  tft.drawString("%", 360, 120, 4);
  tft.drawString("PMax", 10, 160, 4);
  if (BmeUM == 1)tft.drawString("hPa", 360, 160, 4);
  if (BmeUM == 2)tft.drawString("mmHg", 360, 160, 4);
...
void MeniuESensor() {                                //In meniul "Senzor Auxiliar"↓
  ...
  key[3].drawButton();                               //Afiseaza butonul"Maxim"
  key[4].drawButton();                               //Afiseaza butonul"Setari"
  //tft.pushImage(240, 120, 30, 19, MenuIcon);
